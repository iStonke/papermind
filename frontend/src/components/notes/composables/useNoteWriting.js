...
export function useNoteWriting({ editor, surfaceEl, props, overlays, clampMenuLeft, onCheckpoint, stream = streamNoteText }) {
...
return { editor, aiToolbarInputEl, aiPromptInputEl, aiOptionsButtonEl, aiOptionsOpen, aiOptionsLeft, AI_LENGTH_OPTIONS, aiPrompt, aiSelectionTooLong, activeAILengthOption, aiContextLabel, visibleAIPromptSuggestions, prepareToolbarAIPromptTarget, ensureToolbarAIPromptTarget, toggleAIOptions, closeAIOptions, openAIPrompt, closeAIPrompt, applyAIPromptSuggestion, applySelectionAIResult, generateAIText, positionAIPrompt };
}
