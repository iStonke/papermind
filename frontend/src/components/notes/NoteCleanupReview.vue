...
const { editor, cleanup, cleanupRestore, cleanupAnchorEl, cleanupViews, cleanupOriginalText, cleanupDraftText, cleanupDiffParts, cleanupCanApply, closeCleanup, startCleanup, regenerateCleanup, discardCleanup, applyCleanup, restoreCleanupOriginal } = props.controller;
</script>
