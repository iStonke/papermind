...
const importInboxSync = createImportInboxSync({
  refresh: refreshImportInbox,
  subscribe: subscribeImportInbox,
  onPayload: handleImportInboxPayload,
  isOpen: () => isUploadDialogOpen.value,
  onError: (error) => logDevError(error, 'import-inbox-sync'),
});
watch(isUploadDialogOpen, () => importInboxSync.schedule(0));
...
const {
  saveMetadata, scheduleMetadataAutosave, commitMetadataTextFields, dispose: disposeMetadataAutosave,
...
<style src="../workspaces/documents/workspace.css"></style>
